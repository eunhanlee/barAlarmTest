...
import com.example.baralarmtest.Constant.Companion.CHANNEL_DESCRIPTION
import com.example.baralarmtest.Constant.Companion.CHANNEL_ID
import com.example.baralarmtest.Constant.Companion.CHANNEL_NAME
import com.example.baralarmtest.Constant.Companion.NOTIFICATION_DESCRIPTION
import com.example.baralarmtest.Constant.Companion.NOTIFICATION_ID
import com.example.baralarmtest.Constant.Companion.NOTIFICATION_TITLE
    ...
    fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel(
                ...
                /*
                    IMPORTANCE_HIGH - 알림음O 진동O 상태 표시줄O 내부 신호O 헤드업알림O
                    IMPORTANCE_DEFAULT -알림음O 진동O 상태 표시줄O 내부 신호O
